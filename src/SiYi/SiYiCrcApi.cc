...
QStringList SiYiCrcApi::supportedParameterModels()
{
    modelStrings.clear();
...
uint32_t SiYiCrcApi::poly(SiYiCrcApi::SAKEnumCrcModel model)
{
    uint32_t poly = 0;
...
uint32_t SiYiCrcApi::xorValue(SiYiCrcApi::SAKEnumCrcModel model)
{
    uint32_t value = 0;
...
uint32_t SiYiCrcApi::initialValue(SiYiCrcApi::SAKEnumCrcModel model)
{
    uint32_t init = 0;
...
QString SiYiCrcApi::friendlyPoly(SiYiCrcApi::SAKEnumCrcModel model)
{
...
bool SiYiCrcApi::isInputReversal(SiYiCrcApi::SAKEnumCrcModel model)
{
    bool reversal = true;
...
bool SiYiCrcApi::isOutputReversal(SiYiCrcApi::SAKEnumCrcModel model)
{
    bool reversal = true;
...
int SiYiCrcApi::bitsWidth(SiYiCrcApi::SAKEnumCrcModel model)
{
    int ret = -1;
    switch (model) {
    case CRC_8:
...
#ifndef SAK_IMPORT_MODULE_TESTLIB
void SiYiCrcApi::addCrcModelItemsToComboBox(QComboBox *comboBox)
{
    if (comboBox){
        comboBox->clear();
        QMetaEnum enums = QMetaEnum::fromType<SiYiCrcApi::SAKEnumCrcModel>();
